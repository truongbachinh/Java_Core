...
public class Trader implements Comparable<Trader> {
    ...
    private Map<Stock, Integer> Listed_stock = new TreeMap<>();

    public Trader() {
    }

    public Trader(String Id, String Name, String _Address,double Money) {
        this.Id = Id;
        this.Name = Name;
    ...
    public Trader(String Id, String Name, String Address,  double Money, Map<Stock, Integer> Listed_stock) {
        this.Id = Id;
        this.Name = Name;
